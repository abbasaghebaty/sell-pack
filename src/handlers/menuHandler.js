...
export async function showEarnMoneyMenu(
  ...
  return sendMessage(
    ...
    `💰 <b>کسب درآمد با EndMark</b>\n\n` +
      ...
      `۲. فرد معرفی‌شده باید از طریق لینک شما وارد ربات شود.\n` +
      `۳. اگر همان فرد دوره را خریداری کند، <b>۲۰٪ از مبلغ خرید</b> به‌عنوان کمیسیون برای شما در نظر گرفته می‌شود.\n\n` +
      `برای تبلیغ راحت‌تر، از دکمه زیر بنر اختصاصی خودتان را دریافت کنید؛ لینک دعوت شما داخل بنر قرار می‌گیرد.`,
