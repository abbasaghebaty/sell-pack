...
export async function getApprovedPurchase(
  ...
  return getActivePurchase(
    db,
    userId
  );
}

export async function getActivePurchaseByTelegramId(
  db,
  telegramId
) {
  return db
...
export async function getPurchaseByInviteLink(
  db,
  inviteLink
) {
  if (!inviteLink) {
...
export async function createPurchase(
  ...
  if (!purchaseId) {
    throw new Error(
      'Failed to create course purchase.'
    );
  }
